...
class AnthropicEmbedder(BaseEmbedder):
    """Anthropic-based embedding generation"""

    def __init__(self, embedding_config: Optional[EmbeddingConfig] = None):
        self.default_embedding_config = (
            EmbeddingConfig.default_config(model_name="claude-3-opus-20240229", provider="anthropic")
        ...
        self.client: AnthropicClient = cast(
            AnthropicClient,
            LLMClient.create(
